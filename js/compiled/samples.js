...
!(function($, win, doc) {
  ...
  win.system0 = new S({
    ...
    human: new A({
      ...
      matrix: [['spirit', null, null], [null, 'soul', null], [null, null, 'body']]
    })
  });
  win.system1 = {
    root: 'human',
    ...
    human: {
      ...
      featured: false,
      structure: "graph",
      matrix: [['spirit', null, 'sp2b'], ['sp2b', 'soul', 'sp2b'], ['sp2b', null, 'body']]
    }
  };
  win.system2 = new S({
    root: 'virus',
    ...
    virus: new A({
      ...
      structure: "list.inline",
      matrix: [['struct', null, null, null], [null, 'creation', null, null], [null, null, 'being', null], [null, null, null, 'interaction']]
    }),
    struct: new A({
      title: 'Устройство',
      structure: "list.bricks",
      matrix: [['target', null, null], [null, 'hook', null], [null, null, 'delivery']]
    }),
    being: new A({
      title: 'Функционирование',
      structure: "list.bricks",
      matrix: [['management', null, 'dummy1', null], ['dummy5', 'intrusion', null, null], [null, 'dummy2', 'reprogramming', null], [null, 'dummy3', 'dummy4', 'immunity']]
    }),
    creation: new A({
      title: 'Создание',
      structure: "list.bricks",
      matrix: [['stages', null], [null, 'owner']]
    }),
    interaction: new A({
      title: 'Взаимодействие с вирусом',
      structure: "list.inline",
      matrix: [['desease', null, null], [null, 'hygiene', null], [null, null, 'resistance']]
    }),
    intrusion: new A({
    ...
    stages: new A({
      title: 'Процесс',
      structure: 'list.bricks',
      matrix: [['stage1', null, null, null], [null, 'stage2', null, null], [null, null, 'stage3', null], [null, null, null, 'stage4']]
    }),
    dummy1: new A({
      description: 'связь'
    }),
    ...
    desease: new A({
      title: 'Болезнь',
      structure: "list.bricks",
      matrix: [['ideafix', null, null], [null, 'dofamin', null], [null, null, 'media']]
    }),
    ideafix: new A({
    ...
    resistance: new A({
      ...
      structure: "list.bricks",
      matrix: [['clear_sources', null, null, null], [null, 'real_things', null, null], [null, null, 'truth', null], [null, null, null, 'flora']]
    }),
    clear_sources: new A({
  ...
  win.system3 = new S({
    ...
    iface: new A({
      ...
      structure: "graph",
      matrix: [['human', 'input'], ['output', 'machine']]
    }),
    human: new A({
      title: 'Человек',
      structure: "graph",
      matrix: [['goals', 'dummy1', 'dummy2'], ['dummy4', 'mmodel', 'dummy3'], ['dummy5', 'dummy6', 'habits']]
    }),
    machine: new A({
      title: 'Компьютер',
      description: 'Совокупность аппаратного и программного обеспечения',
      structure: "matrix",
      matrix: [['hardware', null], [null, 'software']]
    }),
    dummy1: new A({
      description: 'связь'
    }),
  ...
  win.system4 = new S({
    ...
    progcycl: new A({
      ...
      structure: 'graph',
      matrix: [['analysis', 'link', null], [null, 'design', 'link'], ['link', null, 'usage']]
    }),
    analysis: new A({
      title: 'Анализ',
      structure: 'list.stack',
      matrix: [['s1', null, null], [null, 's2', null], [null, null, 's3']]
    }),
    design: new A({
      title: 'Конструирование',
      structure: 'list.stack',
      matrix: [['s4', null, null], [null, 's5', null], [null, null, 's6']]
    }),
    usage: new A({
      title: 'Использование',
      structure: 'list.stack',
      matrix: [['s7', null, null], [null, 's8', null], [null, null, 's9']]
    }),
    s1: new A({
  ...
  win.system5 = new S({
    ...
    copydetect: new A({
      ...
      structure: 'graph',
      matrix: [['s1', 'l1', 'l2', null, null, null, null, null], [null, 's2', null, null, null, null, null, null], [null, null, 's3', 'l3', 'l4', null, null, null], [null, null, null, 's4', null, 'l7', null, null], [null, null, null, null, 's5', 'l5', null, null], [null, null, null, null, 'l6', 's6', null, null], [null, null, null, null, null, null, 's7', null], [null, null, null, null, null, null, null, 's8']]
    }),
    s1: new A({
  ...
  win.system6 = new S({
    ...
    "human": new A({
      "title": "uKeeper",
      "description": "Дозволяє перетворювати лінк на збережену статтю.\nМагія очищення сторінки від зайвого.",
      "picture": {
        "url": "",
        "pos": "",
        "width": "16",
      ...
      "featured": false,
      "structure": "list.inline",
      "matrix": [["i24279", null], [null, "i39913"]],
      "id": "human",
      "link": {
        url: "http://ukeeper.com/",
        pos: 'title'
      }
    }),
    "i24279": new A({
      ...
      "description": "Працює з поточною сторінкою",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
    ...
    "i39913": new A({
      "title": "drops@ukeeper.com",
      "id": "i39913",
      "link": {
        "url": "",
        "pos": "title"
      },
      "description": "Можна висилати лінки на цей емейл.",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
      ...
      "structure": "graph",
      "matrix": [["i2843", "i58861", null], [null, "i4381", "i84147"], [null, null, "i60050"]]
    }),
    "i2843": new A({
      "title": "From Email",
      "id": "i2843",
      ...
      "description": "Емейл з якого приймаються листи",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
    ...
    "i60050": new A({
      ...
      "description": "Емейл на який переслиються готові статті",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
      ...
      "structure": "list.inline",
      "matrix": [["i84181", null], [null, "i27974"]]
    }),
    "i84181": new A({
      "title": "Evernote",
      "id": "i84181",
      ...
      "description": "Збереження в еверноті",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
    ...
    "i60054": new A({
      ...
      "description": "#tag додавати в кінці сабджекта",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
    ...
    "i27974": new A({
      ...
      "description": "Воно розуміє, що це Кіндл і посилає статтю в аттачменті!",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
    ...
    "i4381": new A({
      ...
      "structure": "list.stack",
      "matrix": [["i63579", null], [null, "i75804"]]
    }),
    "i63579": new A({
      "title": "Force my title",
      "id": "i63579",
      "link": {
        "url": "",
        "pos": "title"
      },
      "description": "Додати \"!\" перед subject",
      "picture": {
        "url": "",
        "pos": "",
        "width": ""
